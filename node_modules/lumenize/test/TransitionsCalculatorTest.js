...
(function() {
  var Time, TransitionsCalculator;

  Time = require('tztime').Time;

  TransitionsCalculator = require('../').TransitionsCalculator;

  exports.TransitionsCalculatorTest = {
    testBasic: function(test) {
      var calculator, config, endBefore, expected, granularity, snapshots, snapshotsToSubtract, startOn, tz;
      snapshots = [
        {
          id: 1,
          from: '2011-01-03T00:00:00.000Z',
          PlanEstimate: 10
        }, {
          id: 1,
          from: '2011-01-05T00:00:00.000Z',
          PlanEstimate: 10
        }, {
          id: 2,
          from: '2011-01-04T00:00:00.000Z',
          PlanEstimate: 20
        }, {
          id: 3,
          from: '2011-01-10T00:00:00.000Z',
          PlanEstimate: 30
        }, {
          id: 4,
          from: '2011-01-11T00:00:00.000Z',
          PlanEstimate: 40
        }, {
          id: 5,
          from: '2011-01-17T00:00:00.000Z',
          PlanEstimate: 50
        }, {
          id: 6,
          from: '2011-01-24T00:00:00.000Z',
          PlanEstimate: 60
        }, {
          id: 7,
          from: '2011-01-25T00:00:00.000Z',
          PlanEstimate: 70
        }, {
          id: 8,
          from: '2011-03-02T00:00:00.000Z',
          PlanEstimate: 80
        }, {
          id: 9,
          from: '2011-03-03T00:00:00.000Z',
          PlanEstimate: 90
        }
      ];
      snapshotsToSubtract = [
    ...
    testSaveRestorAndIncrementalUpdate: function(test) {
      var calculator, calculator2, config, endBefore, expected, granularity, moreSnapshots, moreSnapshotsToSubtract, savedState, snapshots, snapshotsToSubtract, startOn, tz;
      snapshots = [
        {
          id: 1,
          from: '2011-01-03T00:00:00.000Z',
      ...
      calculator = new TransitionsCalculator(config);
      calculator.addSnapshots(snapshots, startOn, endBefore, snapshotsToSubtract);
      savedState = calculator.getStateForSaving({
        a: 1
      });
      moreSnapshots = [
        {
          id: 10,
          from: '2011-04-15T00:00:00.000Z',
          PlanEstimate: 100
        }, {
          id: 11,
          from: '2011-04-16T00:00:00.000Z',
          PlanEstimate: 110
        }
      ];
      ...
      test.deepEqual(calculator2.meta, {
        a: 1
      });
    ...
    testMonthsAndWeeks: function(test) {
      var calculator, config, endBefore, expected, granularity, snapshots, snapshotsToSubtract, startOn, tz, weekStartingLabel;
      snapshots = [
        {
          id: 1,
          from: '2011-01-03T00:00:00.000Z',
          ...
          id: 6,
          from: '2011-02-07T00:00:00.000Z',
          PlanEstimate: 60
        }, {
          id: 7,
          from: '2011-02-08T00:00:00.000Z',
          PlanEstimate: 70
        }
      ];
      snapshotsToSubtract = [
