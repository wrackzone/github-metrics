...
(function() {
  var Time, TimeSeriesCalculator, acceptedValues, arrayOfMaps_To_CSVStyleArray, csvStyleArray_To_ArrayOfMaps, snapshots, snapshotsCSV, utils, _ref, _ref1;
  ...
  exports.TimeSeriesProjection = {
    testBasic: function(test) {
      var calculator, config, expected, granularity, holidays, metrics, projectionsConfig, startOnISOString, tz, upToDateISOString;
    ...
    testPredicateToEnd: function(test) {
      var calculator, config, expected, granularity, holidays, metrics, projectionsConfig, startOnISOString, tz, upToDateISOString;
      granularity = Time.DAY;
      tz = 'America/Chicago';
      holidays = [
    ...
    testVOptimal: function(test) {
      var data, index, result, seriesData, seriesDataCSV;
      data = [
        {
          y: 1
        }, {
    ...
    testVOptimalEndToEnd: function(test) {
      var calculator, config, granularity, holidays, metrics, moreSnapshots, projectionSeries, projectionsConfig, startOnISOString, tz, upToDateISOString;
